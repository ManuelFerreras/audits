...
contract Pot is Ownable(msg.sender) {
    ...
    function closePot() external onlyOwner {
        ...
        if (remainingRewards > 0) {
            ...
            uint256 claimantCut = (remainingRewards - managerCut) / i_players.length; // AUDIT -> Should this be claimants.length? Else this can cause an error in distribution, thus some claimants won't receive a part, or it will be a remaining amount > 0
